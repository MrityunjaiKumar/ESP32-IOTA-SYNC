...
const lmic_pinmap lmic_pins = {
	.nss = ON_BOARD_LORA_NSS,
	.rxtx = LMIC_UNUSED_PIN,
	.rst = ON_BOARD_LoRa_RESET,
	.dio = {ON_BOARD_LoRa_DIO0, LMIC_UNUSED_PIN, LMIC_UNUSED_PIN},
};
...
{
	digitalWrite(ON_BOARD_LED, LOW); // off
}
...
static void rx_func(osjob_t *job)
{
	...
	digitalWrite(ON_BOARD_LED, LOW); // off
	delay(10);
	digitalWrite(ON_BOARD_LED, HIGH); // on
